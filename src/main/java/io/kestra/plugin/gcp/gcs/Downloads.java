...
public class Downloads extends AbstractGcs
        implements RunnableTask<Downloads.Output>, ListInterface, ActionInterface {
    private String from;
                        ...
                        Copy.builder()
                                ...
                                .to(
                                        StringUtils.stripEnd(
                                                        runContext.render(moveDirectory) + "/", "/")
                                                + "/"
                ...
                run.getBlobs().stream()
                        .map(
                                throwFunction(
                                        blob -> {
                                            BlobId source =
                                                    BlobId.of(blob.getBucket(), blob.getName());
                                            File tempFile =
                                                    Download.download(
                                                            runContext, connection, source);
