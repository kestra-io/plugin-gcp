...
@Getter
@NoArgsConstructor
public abstract class AbstractBucket extends AbstractGcs
        implements RunnableTask<AbstractBucket.Output> {
    @NotNull
    ...
    @Schema(
            ...
            description =
                    "Whether a user accessing the bucket or an object it contains should assume the"
    ...
    @Schema(
            ...
            description = "When set to true, versioning is " + " fully enabled.")
    ...
    @Schema(title = "The custom object to return when a requested resource is not found")
    protected String notFoundPage;

    @Schema(
            title = "The bucket's lifecycle configuration",
            description =
                    "This configuration is expressed as a number of lifecycle rules, consisting of"
                        + " an action and a condition. \n"
                        + " See <a href=\"https://cloud.google.com/storage/docs/lifecycle\">Object"
                        + " Lifecycle Management </a> \n"
                        + " Only the age condition is supported. Only the delete and"
                        + " SetStorageClass actions are supported")
    protected List<BucketLifecycleRule> lifecycleRules;

    @Schema(
            title = "The bucket's storage class",
            description =
                    "This defines how blobs in the bucket are stored and  determines the SLA and"
                        + " the cost of storage. A list of supported values is available <a"
    ...
    @Schema(
            ...
            description =
                    "Data for blobs in the bucket resides in physical storage within this region. A"
                        + " list of supported values is available <a"
    ...
    @Schema(
            ...
            description =
                    " See <a"
                        + " href=\"https://cloud.google.com/storage/docs/access-control#About-Access-Control-Lists\">About"
    ...
    @Schema(title = "The labels of this bucket")
    @PluginProperty(dynamic = true)
    protected Map<String, String> labels;

    @Schema(title = "The default Cloud KMS key name for this bucket")
    protected String defaultKmsKeyName;

    @Schema(title = "The default event-based hold for this bucket")
    ...
    protected BucketInfo bucketInfo(RunContext runContext) throws Exception {
        ...
        if (this.storageClass != null) {
            builder.setStorageClass(
                    com.google.cloud.storage.StorageClass.valueOf(this.storageClass.toString()));
        }
    ...
    public static class Output implements io.kestra.core.models.tasks.Output {
        @Schema(title = "The bucket's info")
        private Bucket bucket;

        @Schema(title = "If the bucket was updated.")
        @Builder.Default
        private Boolean updated = false;

        @Schema(title = "If the bucket was created.")
        @Builder.Default
