...
abstract public class AbstractBucket extends AbstractGcs implements RunnableTask<AbstractBucket.Output> {
    ...
    @Schema(title = "Whether the requester pays or not.",
    ...
    @Schema(title = "Whether versioning should be enabled for this bucket",
            description = "When set to true, versioning is " + " fully enabled.")
    protected Boolean versioningEnabled;

    @Schema(title = "The bucket's website index page",
    ...
    @Schema(title = "The bucket's lifecycle configuration",
    ...
    @Schema(title = "The bucket's storage class",
    ...
    @Schema(title = "The bucket's location",
    ...
    @Schema(title = "The Bucket's IAM Configuration",
    ...
    @Schema(title = "The bucket's logging configuration",
