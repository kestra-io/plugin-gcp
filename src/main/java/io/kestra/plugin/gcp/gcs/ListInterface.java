    ...
    @Schema(
            ...
            description =
                    "if DIRECTORY, will only list objects in the specified directory\n"
                        ...
                        + "When using RECURSIVE value, be carefull to move your files to a location"
                        + " not in the `from` scope")
    ...
    @Schema(
            ...
            description =
                    "ex:\n"
                            ...
                            + "`regExp: .*2020-01-0.\\\\.csv` to match files between 01 and 09 of"
                            + " january ending with `.csv`")
    @PluginProperty(dynamic = true)
    String getRegExp();
