...
@Getter
@NoArgsConstructor
public abstract class AbstractPartition extends AbstractTable {
    ...
    protected TableId tableId(RunContext runContext, String partition)
    ...
    protected List<String> listPartitions(
            RunContext runContext, BigQuery connection, TableId tableId)
            throws IllegalVariableEvaluationException {
