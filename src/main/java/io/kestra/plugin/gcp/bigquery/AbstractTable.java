...
@Getter
@NoArgsConstructor
public abstract class AbstractTable extends AbstractBigquery {
    @NotNull
    ...
    public static class Output implements io.kestra.core.models.tasks.Output {
        ...
        @Schema(
                title =
                        "The URL that can be used to access the resource again. The returned URL"
                                + " can be used for get or update requests.")
        ...
        @Schema(
                title =
                        "The number of bytes considered \"long-term storage\" for reduced billing"
                                + " purposes.")
        ...
        private final io.kestra.plugin.gcp.bigquery.models.EncryptionConfiguration
        ...
        @Schema(
                title =
                        "Return true if a partition filter (that can be used for partition"
                                + " elimination) is required for queries over this table.")
        ...
        public static Output of(Table table) {
            return Output.builder()
                    ...
                    .creationTime(
                            table.getCreationTime() == null
                                    ? null
                                    : Instant.ofEpochMilli(table.getCreationTime()))
                    .expirationTime(
                            table.getExpirationTime() == null
                                    ? null
                                    : Instant.ofEpochMilli(table.getExpirationTime()))
                    .lastModifiedTime(
                            table.getLastModifiedTime() == null
                                    ? null
                    ...
                    .encryptionConfiguration(
                            io.kestra.plugin.gcp.bigquery.models.EncryptionConfiguration.of(
                                    table.getEncryptionConfiguration()))
