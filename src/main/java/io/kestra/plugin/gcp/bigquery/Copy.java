...
public class Copy extends AbstractJob implements RunnableTask<Copy.Output> {
    ...
    public Copy.Output run(RunContext runContext) throws Exception {
        ...
        logger.debug(
                ...
                jobConfiguration.getSourceTables(),
    ...
    protected CopyJobConfiguration jobConfiguration(RunContext runContext)
            throws IllegalVariableEvaluationException {
        CopyJobConfiguration.Builder builder =
                CopyJobConfiguration.newBuilder(
                        BigQueryService.tableId(runContext.render(this.destinationTable)),
                        runContext.render(this.sourceTables).stream()
                                .map(BigQueryService::tableId)
