...
public class Field {
    ...
    @Schema(
            title =
                    "the list of sub-fields if `type` is a `LegacySQLType.RECORD`. Returns null"
                            + " otherwise.")
    @PluginProperty(dynamic = true)
    ...
    public com.google.cloud.bigquery.Field to(RunContext runContext)
            throws IllegalVariableEvaluationException {
        com.google.cloud.bigquery.Field.Builder builder =
                com.google.cloud.bigquery.Field.newBuilder(
                        this.getName(),
                        this.getType(),
                        this.getSubFields() == null
                                ? null
                                : FieldList.of(
