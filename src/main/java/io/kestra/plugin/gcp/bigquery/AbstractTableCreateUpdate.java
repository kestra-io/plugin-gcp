...
@Getter
@NoArgsConstructor
public abstract class AbstractTableCreateUpdate extends AbstractTable {
    ...
    @Schema(
            title =
                    "Return true if a partition filter (that can be used for partition elimination)"
    ...
    protected TableInfo.Builder build(TableInfo.Builder builder, RunContext runContext)
            throws Exception {
