...
public class UserDefinedFunction {
    ...
    @Schema(name = "Type of UserDefinedFunction",
    ...
    public static UserDefinedFunction of(com.google.cloud.bigquery.UserDefinedFunction userDefinedFunction) {
        return UserDefinedFunction.builder().type(userDefinedFunction.getType())
                .content(userDefinedFunction.getContent()).build();
    }
