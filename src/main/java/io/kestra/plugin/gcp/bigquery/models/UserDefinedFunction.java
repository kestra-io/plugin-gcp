...
public class UserDefinedFunction {
    @Schema(name = "the type of user defined function.")
    ...
    @Schema(
            ...
            description =
                    "If `type` is UserDefinedFunction.Type.INLINE this method returns a code"
                            + " blob.\n"
                            + "If `type` is UserDefinedFunction.Type.FROM_URI the method returns a"
                            + " Google Cloud Storage URI (e.g. gs://bucket/path)")
    @PluginProperty(dynamic = true)
    private final String content;

    public static UserDefinedFunction of(
            com.google.cloud.bigquery.UserDefinedFunction userDefinedFunction) {
    ...
    public com.google.cloud.bigquery.UserDefinedFunction to(RunContext runContext)
