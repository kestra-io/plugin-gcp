...
public class BigQueryToBigQueryStorageSchemaConverter {
    private static final ImmutableMap<Field.Mode, TableFieldSchema.Mode> BQ_TABLE_SCHEMA_MODE_MAP =
            ImmutableMap.of(Field.Mode.NULLABLE, TableFieldSchema.Mode.NULLABLE, Field.Mode.REPEATED,
                    TableFieldSchema.Mode.REPEATED, Field.Mode.REQUIRED, TableFieldSchema.Mode.REQUIRED);
