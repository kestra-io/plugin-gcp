...
public class StandardTableDefinition {
    @Schema(
            title =
                    "Returns information on the table's streaming buffer if any exists. Returns"
                            + " {@code null} if no streaming buffer exists.")
    private final StreamingBuffer streamingBuffer;

    @Schema(
            title =
                    "Returns the clustering configuration for this table. If {@code null}, the"
                            + " table is not clustered.")
    private final List<String> clustering;

    @Schema(
            title =
                    "Returns the time partitioning configuration for this table. If {@code null},"
                            + " the table is not time-partitioned.")
    private final TimePartitioning timePartitioning;

    @Schema(
            title =
                    "Returns the range partitioning configuration for this table. If {@code null},"
    ...
    public static StandardTableDefinition of(
        ...
        return StandardTableDefinition.builder()
                ...
                .clustering(
                        standardTableDefinition.getClustering() == null
                                ? null
                                : standardTableDefinition.getClustering().getFields())
                .timePartitioning(
                        standardTableDefinition.getTimePartitioning() == null
                                ? null
                                : TimePartitioning.of(
                                        standardTableDefinition.getTimePartitioning()))
                .rangePartitioning(
                        standardTableDefinition.getRangePartitioning() == null
                                ? null
                                : RangePartitioning.of(
                                        standardTableDefinition.getRangePartitioning()))
                .build();
    }

    public com.google.cloud.bigquery.TableDefinition to(
            RunContext runContext, io.kestra.plugin.gcp.bigquery.models.Schema schema)
        ...
        if (this.clustering != null) {
            builder.setClustering(
                    Clustering.newBuilder().setFields(runContext.render(this.clustering)).build());
        }
