...
public class ExternalTableDefinition {
    @Schema(
            ...
            description =
                    "Each URI can\n"
                        + "* contain one '*' wildcard character that must come after the bucket's"
                        + " name. Size limits related\n"
                        + "* to load jobs apply to external data sources, plus an additional limit"
                        + " of 10 GB maximum size\n"
                        + "* across all URIs.")
    ...
    public static ExternalTableDefinition of(
        ...
        ExternalTableDefinitionBuilder builder =
        ...
        if (externalTableDefinition.getFormatOptions() != null) {
            builder.formatType(
                    FormatType.valueOf(externalTableDefinition.getFormatOptions().getType()));
        }
        return builder.build();
    }

    public com.google.cloud.bigquery.ExternalTableDefinition to(
        ...
        com.google.cloud.bigquery.ExternalTableDefinition.Builder builder =
                com.google.cloud.bigquery.ExternalTableDefinition.newBuilder(
