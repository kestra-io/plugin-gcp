...
public class ExternalTableDefinition {
    @Schema(title = "the fully-qualified URIs that point to your data in Google Cloud Storage.",
    ...
    @Schema(title = "the maximum number of bad records that BigQuery can ignore when reading data.",
    ...
    public static ExternalTableDefinition of(
        ...
        ExternalTableDefinitionBuilder builder = ExternalTableDefinition.builder()
                .sourceUris(externalTableDefinition.getSourceUris()).autodetect(externalTableDefinition.getAutodetect())
    ...
    public com.google.cloud.bigquery.ExternalTableDefinition to(RunContext runContext,
        ...
        com.google.cloud.bigquery.ExternalTableDefinition.Builder builder =
                com.google.cloud.bigquery.ExternalTableDefinition.newBuilder(runContext.render(this.sourceUris),
                        schema.to(runContext), FormatOptions.of(this.formatType.name()));
    ...
    public enum FormatType {
        CSV, JSON, BIGTABLE, DATASTORE_BACKUP, AVRO, GOOGLE_SHEETS, PARQUET, ORC,
    }
}
