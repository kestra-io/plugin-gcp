...
public class Message {
    ...
    public static Message of(PubsubMessage message) {
        return Message.builder().messageId(message.getMessageId()).data(message.getData().toString())
                .attributes(message.getAttributesMap()).orderingKey(message.getOrderingKey()).build();
    }
}
