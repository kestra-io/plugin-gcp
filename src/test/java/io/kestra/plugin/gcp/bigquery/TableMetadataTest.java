...
class TableMetadataTest {
    ...
    private Job query(BigQuery bigQuery, String query) throws InterruptedException {
        return bigQuery.create(
                        JobInfo.newBuilder(QueryJobConfiguration.newBuilder(query).build())
    ...
    void table() throws Exception {
        ...
        assertThat(
                run.getDefinition().getSchema().getFields().get(1).getType(),
                is(StandardSQLTypeName.INT64));
        assertThat(
                run.getDefinition().getStandardTableDefinition().getClustering().get(0),
                is("quantity"));
        assertThat(
                run.getDefinition().getStandardTableDefinition().getTimePartitioning().getField(),
                is("date"));
    }
    ...
    void view() throws Exception {
        ...
        assertThat(
                run.getDefinition().getSchema().getFields().get(2).getType(),
                is(StandardSQLTypeName.FLOAT64));
    }
