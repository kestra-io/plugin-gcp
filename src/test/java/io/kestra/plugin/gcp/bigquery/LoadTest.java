...
class LoadTest {
    ...
    void fromCsv() throws Exception {
        ...
        Load task =
                Load.builder()
                        ...
                        .destinationTable(
                                project + "." + dataset + "." + FriendlyId.createFriendlyId())
                                ...
                                new File(
                                        Objects.requireNonNull(
                                                        LoadTest.class
                                                                .getClassLoader()
                                                                .getResource(
                                                                        "bigquery/insurance_sample.avro"))
                                                .toURI())));
    ...
    void fromEmpty() throws Exception {
        ...
        RunContext runContext =
                TestsUtils.mockRunContext(runContextFactory, task.build(), ImmutableMap.of());
