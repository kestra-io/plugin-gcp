    ...
    static Stream<Arguments> source() {
        return Stream.of(
                Arguments.of(
                        ...
                        "DATE_TRUNC(transaction_date, HOUR)", AbstractPartition.PartitionType.HOUR,
                        "2020-04-01T13:00:00", "2020-04-01T15:00:00"),
                Arguments.of(
                        "(SELECT 1, DATETIME '2020-04-01 12:30:00.45')\n" + "UNION ALL\n"
                        ...
                        "DATE(transaction_date)", AbstractPartition.PartitionType.DAY, "2020-04-02T00:00:00",
                        "2020-04-04T00:00:00"),
                Arguments.of(
                        ...
                        "DATE_TRUNC(transaction_date, MONTH)", AbstractPartition.PartitionType.MONTH,
                        "2020-02-01T00:00:00", "2020-04-04T00:00:00"),
                Arguments.of(
                        "(SELECT 1, DATETIME '2020-01-01 12:30:00.45')\n" + "UNION ALL\n"
                        ...
                        "DATE_TRUNC(transaction_date, YEAR)", AbstractPartition.PartitionType.YEAR,
                ...
                Arguments.of(
                        ...
                        AbstractPartition.PartitionType.RANGE, "2", "4"));
    }

    @ParameterizedTest
    @MethodSource("source")
    void deleteDate(String insert, String partition, AbstractPartition.PartitionType partitionType, String from,
        ...
        DeletePartitions task = DeletePartitions.builder().id(QueryTest.class.getSimpleName())
                .type(DeleteTable.class.getName()).projectId(this.project).dataset(this.dataset)
                .partitionType(partitionType).table(table).from(from).to(to).build();
